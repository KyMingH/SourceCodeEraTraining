...
public class EducationClassController extends BaseController
{
    ...
    @PreAuthorize("@ss.hasPermi('system:class:edit')")
    @Log(title = "班级管理", businessType = BusinessType.UPDATE)
    @PutMapping("/beginClass")
    public AjaxResult begin_class(@RequestBody EducationClass educationClass)
    {
        return toAjax(educationClassService.begin_class(educationClass));
    }
    ...
    @Log(title = "班级管理", businessType = BusinessType.UPDATE)
    @PutMapping("/endClass")
    public AjaxResult end_class(@RequestBody EducationClass educationClass)
    {
        return toAjax(educationClassService.end_class(educationClass));
    }
