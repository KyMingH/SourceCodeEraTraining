  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="沟通效果" prop="communicationEffectivenessRating">
        <el-input
          v-model="queryParams.communicationEffectivenessRating"
          placeholder="请输入沟通效果"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="沟通效果" prop="communicationEffectivenessRating">
          <el-input v-model="form.communicationEffectivenessRating" placeholder="请输入沟通效果" />
        </el-form-item>
    ...
    return {
      ...
      rules: {
        ...
        communicationEffectivenessRating: [
          { required: true, message: "沟通效果不能为空", trigger: "blur" }
        ],
      }
    };
  },
