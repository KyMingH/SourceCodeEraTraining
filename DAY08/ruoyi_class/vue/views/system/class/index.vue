<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="classList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="开班时间" align="center" prop="beginTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.beginTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="实际开班时间" align="center" prop="beginTimeReal" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column label="实际结课时间" align="center" prop="endTimeReal" width="180">
        <template slot-scope="scope">
