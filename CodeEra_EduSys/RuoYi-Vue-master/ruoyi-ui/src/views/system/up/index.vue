<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="回访人" prop="followUpPerson">
        <el-input
    ...
    <el-table v-loading="loading" :data="upList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="回访ID" align="center" prop="followUpId" />
      ...
      <el-table-column label="回访内容" align="center" prop="followUpContent" />
      <el-table-column label="回访人" align="center" prop="followUpPerson" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="回访人" prop="followUpPerson">
          <el-input v-model="form.followUpPerson" placeholder="请输入回访人" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      if (null != this.daterangeFollowUpDate && '' != this.daterangeFollowUpDate) {
        this.queryParams.params["beginFollowUpDate"] = this.daterangeFollowUpDate[0];
        this.queryParams.params["endFollowUpDate"] = this.daterangeFollowUpDate[1];
      }
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除alumni_follow_up编号为"' + followUpIds + '"的数据项？').then(function() {
