...
public class EducationClassServiceImpl implements IEducationClassService
{
     ...
     */
    @Override
    public int begin_class(EducationClass educationClass) {
        educationClass.setUpdateTime(DateUtils.getNowDate());
        educationClass.setBeginTimeReal(DateUtils.getNowDate());
        educationClass.setState("已开课");
        return educationClassMapper.updateEducationClass(educationClass);
    }

    @Override
    public int end_class(EducationClass educationClass) {
        educationClass.setUpdateTime(DateUtils.getNowDate());
        educationClass.setEndTimeReal(DateUtils.getNowDate());
        educationClass.setState("已结课");
        return educationClassMapper.updateEducationClass(educationClass);
    }
}
